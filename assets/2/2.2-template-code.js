...
async function main() {
    ...
    // Modify the oprtions.peerInfo to add the fixed info
    ...
    // Modify the port from 0 to 63685
    libp2p.peerInfo.multiaddrs.add('/ip4/0.0.0.0/tcp/0')
    // Modify the port from 0 to 63786 (Make sure the port fixed is not same as above)
